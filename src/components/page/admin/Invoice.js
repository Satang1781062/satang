      ...
      <Document>
        <Page size="A4" style={styles.page}>
          <View style={styles.section}>
            <Text style={styles.text}>360 HealthyShop</Text>
            ...
            <Text>ที่อยู่จัดส่ง:</Text>
              <Text>ชื่อผู้รับ: {sanitizedText(name)}</Text>
              <Text>โทรศัพท์: {sanitizedText(phone)}</Text>
              <Text>อีเมล: {sanitizedText(email)}</Text>
              <Text>ที่อยู่จัดส่ง: {sanitizedText(address)}</Text>
            </View>
          </View>
        </Page>
      </Document>
